...
def run():
  ...
  gradepoint1 = getGradePoint(lettergrade) 
  print (f"The grade point for course 1 is: {gradepoint1}") 

  lettergrade = input("Enter your course 2 letter grade: ")
  credit2 = int(input("Enter your course 2 credit: "))
  gradepoint2 = getGradePoint(lettergrade) 
  print (f"The grade point for course 2 is: {gradepoint2}")

  lettergrade = input("Enter your course 3 letter grade: ")
  credit3 = int(input("Enter your course 3 credit: "))
  gradepoint3 = getGradePoint(lettergrade) 
  print (f"The grade point for course 3 is: {gradepoint3}")
